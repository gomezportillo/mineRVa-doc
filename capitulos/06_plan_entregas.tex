...
6       
&
Terminar la séptima sala, el almacén del vigilante y la sala final e integrar el resto de elementos restantes
\newline
\newline
\begin{tabular}{p{.01\textwidth} p{.55\textwidth}}
  \firsthline
  ...
  1 & Diseñar la séptima sala y elegir el cuadro robado\\ \hline
  2 & Incluir un modelo del vigilante y añadirle animaciones\\ \hline
  3 & Desarrollar un sistema de diálogos\\ \hline
  4 & Añadir las descripciones al resto de cuadros\\ \hline
  5 & Desarrollar un menú de juego inicial\\ \hline
  6 & Añadir música de fondo y efectos de sonido\\ \hline
  \end{tabular} 
\newline
&
25/6
